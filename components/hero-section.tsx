...
export function HeroSection() {
  ...
  const handleDownloadCV = () => {
    ...
    const cvUrl = '/CV - JGJ -0707.pdf'; // Asegúrate de que el nombre del archivo coincida
    ...
    link.setAttribute('download', 'CV - JGJ -0707.pdf'); 
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Hola, soy <span className="text-blue-600">Jesús Galvis</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
              Desarrollador Full Stack especializado en .NET y tecnologías web modernas.
            </p>
            <p className="text-lg text-gray-500 mb-8">
              Destaco por mi habilidad para trabajar en equipo y mi disposición para aprender continuamente.
            </p>
